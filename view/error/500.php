...
<head>
    ...
    <title>500 -:- INTERNAL ERRO</title>
</head>
<body>


<div class="error-page e-400">
  <figure>
    <img src="<?php echo base_url;?>assets/img/500.svg" alt="">
  </figure>

  <div>
    <h1 data-h1="500">500</h1>
    <p data-p="ERROR INTERNO DEL SERVIDOR">ERROR INTERNO DEL SERVIDOR</p>
  </div>
</div>
